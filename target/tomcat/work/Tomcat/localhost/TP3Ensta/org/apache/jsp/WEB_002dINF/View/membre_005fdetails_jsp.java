 ...
 * Generated at: 2022-04-04 00:15:25 UTC
 ...
 MembreService membreService = MembreService.getInstance(); 
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.print( membreService.getById(Integer.valueOf(request.getParameter("id"))).getNom() );
      ...
      out.print( membreService.getById(Integer.valueOf(request.getParameter("id"))).getPrenom() );
      ...
      out.print( (membreService.getById(Integer.valueOf(request.getParameter("id"))).getAbonnement().name() == "BASIC") ? " selected" : "" );
      out.write("> Abonnement BASIC</option>\n");
      out.write("\t              <option value=\"PREMIUM\" ");
      out.print( (membreService.getById(Integer.valueOf(request.getParameter("id"))).getAbonnement().name() == "PREMIUM") ? " selected" : "" );
      out.write(">Abonnement PREMIUM</option>\n");
      out.write("\t              <option value=\"VIP\" ");
      out.print( (membreService.getById(Integer.valueOf(request.getParameter("id"))).getAbonnement().name() == "VIP") ? " selected" : "" );
      ...
      out.print( membreService.getById(Integer.valueOf(request.getParameter("id"))).getAdresse() );
      ...
      out.print( membreService.getById(Integer.valueOf(request.getParameter("id"))).getEmail() );
      ...
      out.print( membreService.getById(Integer.valueOf(request.getParameter("id"))).getTelephone() );
      ...
      // /WEB-INF/View/membre_details.jsp(94,16) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("current");
      // /WEB-INF/View/membre_details.jsp(94,16) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/View/membre_details.jsp(94,16) '${ListeEmpruntsCurrentMembre}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${ListeEmpruntsCurrentMembre}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
