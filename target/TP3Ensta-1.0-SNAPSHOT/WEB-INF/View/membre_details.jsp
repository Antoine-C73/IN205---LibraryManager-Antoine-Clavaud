...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Détails du membre n°${param.id}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      ...
	      <form action="/TP3Ensta/membre_details?id=${param.id}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="<%= membreService.getById(Integer.valueOf(request.getParameter("id"))).getPrenom() %>" name="prenom"> <!-- TODO : remplacer prenomDuMembre par le prénom du membre -->
	        ...
	        <div class="row">
	          ...
	          <div class="input-field col s6">
	            <input id="telephone" type="tel" value="<%= membreService.getById(Integer.valueOf(request.getParameter("id"))).getTelephone() %>" name="telephone"> <!-- TODO : remplacer telephoneDuMembre par le téléphone du membre -->
