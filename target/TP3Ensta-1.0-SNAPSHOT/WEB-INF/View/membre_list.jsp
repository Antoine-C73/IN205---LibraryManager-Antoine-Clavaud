      ...
      <div class="row">
	    <div class="col s12">
	      <table class="striped no-padding">
            ...
            <tbody>
			    <c:forEach var="current" items="${ListeMembres}" >
	              <tr>
	                <td>${current.nom}</td>
	                ...
	                <td class="center"><a href="membre_details?id=${current.id}"><ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
	              </tr>
	            </c:forEach>
