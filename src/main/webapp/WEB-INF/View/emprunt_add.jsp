	        ...
	        <div class="row">
	          <div class="input-field col s6">
	            <select id="idLivre" name="idLivre" class="browser-default">
                  ...
                  <c:forEach var="current" items="${ListeLivreDispo}" >
                  	<option value="${current.id}">${current.titre}, de ${current.auteur}</option>
                  </c:forEach>	
	            </select>
	          </div>
	          <div class="input-field col s6">
	            <select id="idMembre" name="idMembre" class="browser-default">
                  ...
                  <c:forEach var="current" items="${ListeMembresPeuventEmprunter}" >
                  	<option value="${current.id}">${current.prenom} ${current.nom}</option>
                  </c:forEach>
	            </select>
	          </div>
	        </div>
