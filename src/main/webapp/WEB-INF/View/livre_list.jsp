      ...
      <div class="row">
	        ...
	        <div class="col s12">
	          <table class="striped no-padding">
                ...
                <tbody>
                  <c:forEach var="current" items="${ListeLivres}" >
                    <tr>
                        <td>${current.titre}</td>
                        <td>${current.auteur}</td>
                        <td>${current.isbn}</td>
                        <td class="center"><a href="livre_details?id=${current.id}"><ion-icon class="details" name="information-circle-outline"></ion-icon></a></td>
                    </tr>
                  </c:forEach>                    
